 ...
 * the 6 NEXinfra Canonical Civic Categories.
 *
 ...
 * @param {string|number} rawClass - Raw class name, model index, or tag
 * @returns {string} Canonical Civic Category name
 */
 ...
 * @param {string|number} rawClass - Raw class name or canonical category
 * @returns {Object} Complete canonical metadata
 */
