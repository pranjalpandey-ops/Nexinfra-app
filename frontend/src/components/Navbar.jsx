      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <button
            ...
            className="md:hidden p-2 mr-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 hover:text-white transition-colors"
            aria-label="Open navigation"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12h18M3 6h18M3 18h18"></path></svg>
          </button>
        ...
        >
          <Logo size="md" theme={theme} className="group-hover:scale-105 transition-transform flex-shrink-0" />

          <div className="max-w-[220px]">
            <span
              className="text-2xl font-bold tracking-[0.02em] text-white group-hover:text-cyan-400 transition-all duration-300 truncate block"
